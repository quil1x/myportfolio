...
const Map<String, Map<String, String>> localizedStrings = { //
  'uk': {
    ...
    'nav_about': 'Про Мене', //
    'nav_about_nether': 'Про Незер', // ДОДАНО для зміни назви в навігації
    'nav_projects': 'Проєкти', //
    'nav_contacts': 'Контакти', //
    'nav_nether_portal': 'ЯƎHTƎN', // Цей ключ використовувався раніше, можеш залишити або видалити, якщо більше не потрібен
    ...
    'nether_about_title': 'ПРО НЕЗЕР (З Minecraft Wiki):', //
    ...
    'settings_action_enter_nether': 'Портал в Незер', // ДОДАНО для кнопки в налаштуваннях
  ...
  'en': {
    ...
    'nav_about': 'About Me', //
    'nav_about_nether': 'About Nether', // ДОДАНО для зміни назви в навігації
    'nav_projects': 'Projects', //
    'nav_contacts': 'Contacts', //
    'nav_nether_portal': 'ЯƎHTƎN', //
    ...
    'nether_about_title': 'ABOUT THE NETHER (from Minecraft Wiki):', //
    ...
    'settings_action_enter_nether': 'Nether Portal', // ДОДАНО для кнопки в налаштуваннях
